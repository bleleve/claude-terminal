...
├── src/renderer/i18n/               # EN/FR/ES/ID/zh-CN locales (3721 keys each)
...
- **Keys:** 3721 per locale, all five in exact sync (enforced by `tests/i18n/i18n-coherence.test.js`)
